                                ...
                                <div class="dropdown">
                                    ...
                                    <ul class="dropdown-menu">
                                        ...
                                        <li><a href="javascript:void(0)" class="dropdown-item"><i class="mdi mdi-lock-open-outline text-muted me-2"></i>
                                                Lock screen</a></li>
                                        <li><a href="logout.php" class="dropdown-item"><i class="mdi mdi-power text-muted me-2"></i>
                                                Logout</a></li>
                                    </ul>
                                </div>

                                <p class="text-white-50 m-0">Welcome</p>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="col-12">
                                <div class="page-title-box d-flex align-items-center justify-content-between">
                                    <div class="page-title">
                                        ...
                                        <ol class="breadcrumb">
                                            <li class="breadcrumb-item active">Welcome to Karnak <?php echo htmlspecialchars($_SESSION['username']); ?></li>
                                        </ol>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="container-fluid">
                        <div class="row">
                            <div class="col-sm-12 text-center">
                                <script>document.write(new Date().getFullYear())</script> © Karnak <span
